...
1. Compute $e_{40}$ using recursion formula
2. Solve for $e_{41}$ using reverse recursion
"""

life = Recursion().set_e(25, x=60, curtate=True)
life.set_q(0.2, x=40, t=20).set_q(0.003, x=40)
def fun(e):  # solve e_40 from actuarialmath.e_40:20 = e_40 - 20_p_40 e_60
    return life.set_e(e, x=40, curtate=True).e_x(x=40, t=20, curtate=True)
life.solve(fun, target=18, guess=[36, 41])
...
2. Variancs is difference of second moment and first moment squared
"""
