...
from mathlc.recursion import Recursion
from mathlc.lifetable import LifeTable
from mathlc.sult import SULT
from mathlc.selectlife import Select
from mathlc.constantforce import ConstantForce
from mathlc.adjustmortality import Adjust
from mathlc.mthly import Mthly
from mathlc.udd import UDD
from mathlc.woolhouse import Woolhouse
...
if __name__ == "__main__":
    ...
    v = math.sqrt(FAML.conditional_variance(p=.2, p1=p1, p2=p2, N=100000))
    soa(400, v, 2.2)
    ...
    cov = FAML.covariance(a=1.65, b=10.75, ab=0)  # E[Z1 Z2] = 0 nonoverlapping
    soa(167, FAML.variance(a=2, b=1, var_a=46.75, var_b=50.78, cov_ab=cov), 4.12)
