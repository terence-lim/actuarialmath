...
- SOA sample question 5.7: Given $A_{35} = 0.188$, $A_{65} = 0.498$, $p_{30} p_{35} = 0.883$, calculate the EPV of a temporary annuity $\ddot{a}^{(2)}_{35:\overline{30|}}$ paid half-yearly using the Woolhouse approximation.
